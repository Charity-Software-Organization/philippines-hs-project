...
public interface LauncherConstant {
	 ...
	 * nacos namespace id
	 */
	String NACOS_NAMESPACE = "4c0fc25b-4dea-4791-ba41-a1d54d548a6b";

	/**
	 * nacos dev 地址
	 */
	String NACOS_DEV_ADDR = "nacos.ltserver.lan:8848";

	/**
	 * nacos prod 地址
	 */
	String NACOS_PROD_ADDR = "nacos.ltserver.lan:8848";

	/**
	 * nacos test 地址
	 */
	String NACOS_TEST_ADDR = "nacos.ltserver.lan:8848";

	/**
	 * sentinel dev 地址
	 */
	String SENTINEL_DEV_ADDR = "sentinel.ltserver.lan:8858";

	/**
	 * sentinel prod 地址
	 */
	String SENTINEL_PROD_ADDR = "sentinel.ltserver.lan:8858";

	/**
	 * sentinel test 地址
	 */
	String SENTINEL_TEST_ADDR = "sentinel.ltserver.lan:8858";
